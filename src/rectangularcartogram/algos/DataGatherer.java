...
public class DataGatherer extends LabelingTraverser {

    private QualityMeasure m;

    public DataGatherer(Graph graph, QualityMeasure m) throws IncorrectGraphException {
        super(graph);
        this.m = m;
    }
    ...
    protected void processLabeling(RegularEdgeLabeling labeling) {
        m.getQuality(labeling);
    }

    public void gatherData() throws IncorrectGraphException {
        traverseLabelings();
    }
}
